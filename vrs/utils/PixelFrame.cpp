...
PixelFormat PixelFrame::getNormalizedPixelFormat(
  ...
  // For testing only
  fmt::print("--- --- debug: source pixel fromat is {}\n", static_cast<int>(format));
  ...
  // For testing only
  fmt::print("--- --- debug: returned pixel fromat is {}\n", static_cast<int>(format));
...
bool PixelFrame::normalizeFrame(
  ...
  // For testing only
  fmt::print("--- --- debug: source pixel format is {}\n", toString(srcFormat));
  fmt::print("--- --- debug: normalized pixel format is {}\n", toString(normalizedPixelFormat));
