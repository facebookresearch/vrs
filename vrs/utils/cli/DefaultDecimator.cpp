...
void DefaultDecimator::Params::decimate(FilteredFileReader& filteredReader) const {
  filteredReader.decimator_ = make_unique<DefaultDecimator>(filteredReader, *this);
}

DefaultDecimator::DefaultDecimator(
    FilteredFileReader& filteredReader,
    const DefaultDecimator::Params& params)
