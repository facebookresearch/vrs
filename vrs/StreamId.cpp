...
const unordered_map<RecordableTypeId, const char*>& getRecordableTypeIdRegistry() {
  static const unordered_map<RecordableTypeId, const char*> sRegistry = {
      ...
      {RecordableTypeId::ProximitySensorRecordableClass, "Proximity Sensor Data Class"},
      {RecordableTypeId::ButtonStateRecordableClass, "Button State Data Class"},
      ...
      {RecordableTypeId::Detection2dRecordableClass, "Detection 2D Data Class"},
...
string StreamId::getFullName() const {
  return fmt::format("{}-{} - {}", static_cast<int>(typeId_), instanceId_, getTypeName());
}

string StreamId::getNumericName() const {
  return fmt::format("{}-{}", static_cast<int>(typeId_), instanceId_);
}
