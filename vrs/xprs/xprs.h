...
class IVideoEncoder {
 public:
   ...
   * @param logFolderPath Encoder log folder path. Can be NULL if not needed.
   * @return XprsResult
   */
  virtual XprsResult init(const EncoderConfig& config, const std::string& logFolderPath) = 0;
...
class IVideoDecoder {
 public:
   ...
   * @return XprsResult
   */
  virtual XprsResult init(const std::string& logFolderPath) = 0;
